...
package cn.ragehealth.authenticators;
 ...
 * @author yangjian
 */
public class IdpOwnCreateUserIfUniqueAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "idp-own-create-user-if-unique";
    static IdpOwnCreateUserIfUniqueAuthenticator  SINGLETON = new IdpOwnCreateUserIfUniqueAuthenticator();
    ...
    public String getDisplayType() {
        return "Own Create User If Unique";
    }

    @Override
    public String getHelpText() {
        return "Own Custom Create User if Unique";
    }
