 ...
 * @author yangjian
 */
public class IdpOwnCreateUserIfUniqueAuthenticator extends AbstractIdpAuthenticator {

    private static Logger logger = Logger.getLogger(IdpOwnCreateUserIfUniqueAuthenticator.class);
